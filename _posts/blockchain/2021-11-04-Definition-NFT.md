...
하지만 1998년에 발행된 500원짜리가 100만원에 거래 되었습니다.  
[("500원 동전 100만 원에 삽니다" 중고거래 '금값'된 희귀 화폐, 대구일보)](https://www.idaegu.com/newsView/idg202103260001)  
...
3. 소유권 인정
공유 네트워크에 블록체인방식으로 저장하기 때문에 소유권을 증명할 수 있습니다. 토큰을 이용해 소유권을 분할할 수도 있습니다.
...
Meta-Mask계정을 만들었으면 OpenSea에 로그인합시다.
...
![]({{site.url}}/assets/built/images/blockchain/NFT/2021-11-04-17-57-29.png)
...
토큰 : 독립된 블록체인 네트워크를 소유하지 않은 경우 토큰으로 부른다.   
====------------------------------------------------------------------------------------------------------------------------------------------------------------
